...
import { Button, Card, CardBody, Progress, Divider, Spinner, Chip, Skeleton } from "@nextui-org/react";
import {
...
const DashboardPage = ({ userData }) => {
    ...
    useEffect(() => {
        ...
        if (!isLoading) {
            ...
            if (forceShow || !alreadySeen) {
                ...
                // Si es forzado, limpiamos el flag inmediatamente para que no lo muestre en F5
                ...
                const timer = setTimeout(() => {
                    ...
                    // Doble check por siel usuario navegó rápido
                    ...
                    driverRef.current = driver({
                        ...
                        onDestroyStarted: () => {
                            ...
                            // Marcamos que ya lo vio SIEMPRE al cerrar
    ...
    const stats = useMemo(() => {
        ...
        // Fix: Priorizar eventos futuros o de hoy. Si hay vencidos, no mostrarlos como "Próximo".
        // Esto resuelve que se vean cosas viejas cuando hay nuevas.
        const todayStr = now.toISOString().split('T')[0];
        const proximos = pendientes.filter(t => t.fechaEntrega >= todayStr);
    ...
    // SPINNER DE CARGA (REEMPLAZADO POR SKELETONS)
    if (isLoading) {
        return (
