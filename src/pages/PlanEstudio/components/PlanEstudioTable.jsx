...
import { Trash2, Edit, AlertTriangle, CheckCircle2, BookOpen } from "lucide-react";
        ...
        return (
          <div className="relative flex items-center gap-2">
            {materia.estado === "Cursando" && (
              <Tooltip content="Ver detalle de cursada">
                <span className="text-lg text-primary cursor-pointer active:opacity-50" onClick={() => navigate(`/cursando/${materia.id}`)}>
                  <BookOpen size={18} />
                </span>
              </Tooltip>
            )}
